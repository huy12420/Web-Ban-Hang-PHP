            ...
            <div class="cart-content row">
                ...
                <div class="cart-content-right">
                    ...
                    <div class="cart-content-right-text">
                        ...
                        if($TT>= 2000000) {
                        ?>
                         <p style="color: red;font-weight: bold;">Đơn hàng của bạn đủ điều kiện được 100 điểm tích lũy  <span style="font-size: 18px;"> đăng nhập để được tích điểm</span></p>
                        <?php
                        } else {
                        ?>

                         <p style="color: red;font-weight: bold;">Mua thêm <span style="font-size: 18px;"><?php $them = 2000000 - $TT; $resultC = number_format($them); echo $resultC  ?><sup>đ</sup></span> để được +100 điểm tích lũy</p>
                        <?php
                        }
                        ?>
                    </div>
