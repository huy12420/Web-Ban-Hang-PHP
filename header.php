    ...
    <secsion class="top">
        <div class="container">
            <div class="row">
                ...
                <div class="top-logo">
                    <a href="index.php"><img src="image/logo3.jpg" alt=""></a>
                </div>
                ...
                <div class="top-menu-icons">
                    <ul>
                        <li> 
                            <b style="font-size: 30px;"> <i> Chào <?php echo $username?> </i> </b>
                        </li>  
                        <li> <a href="login.php" style="font-family: Times New Roman, Times, serif; "> Đăng Nhập </li>
                        <li>
